		...
		<div class="content">
			...
			<form name="myForm" onsubmit="return validateForm()"action ="login" method ="post" class="login_form">
				<div class="wrap-input">
	            	<input id="input_e" class="input" type ="email" name ="email_login" placeholder="E-mail" 
	            	 maxlength="50" />
	            </div>
	            <div class="wrap-input">
	            	<input id="input_p" class="input" type ="password" name ="password_login" placeholder="Password"
	            	 maxlength="30" />
	            </div>
	            <div class="wrap-input">
