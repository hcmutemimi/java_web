...
<body>
	<div class="all">
		<div class="icon_and_text">
			<div class="error_icon"><i class="fa fa-exclamation-triangle" aria-hidden="true" style="color:red;"></i></div>
			<div class="error" id="error" >This email is already in use</div>
		</div>
			...
			<form name="myForm" action ="register" onsubmit="return validateForm()" method ="post" class="register_form">
				<div class="wrap-input">
	            	<input id="input_u" class="input" type ="text" name ="username" placeholder="User name" 
	            		value="${model.username}" maxlength="30" required="required"/>
	            </div>
				<div class="wrap-input">
	            	<input id="input_e" class="input_error" type ="email" name ="email" placeholder="E-mail" 
	            		value="${model.email}" required="required"/>
	            </div>
	            <div class="wrap-input">
	            	<input id="input_p" class="input" type ="password" name ="password" placeholder="Password" 
	            		value="${model.password}" maxlength="30" required="required"/>
	            </div>
	            <div class="wrap-input">
	            	<input id="input_rp" class="input" type ="password" name ="re_password" placeholder="Re Password" 
	            		value="${model.re_password}" maxlength="30" required="required"/>
	            </div>
	            <div class="wrap-input">
